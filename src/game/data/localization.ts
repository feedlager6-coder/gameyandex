...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  ru: {
    ...
    level_abbr: 'Ур.',
    plot_level: 'Уровень: {level}/{max}',
    new_item_unlocked: 'Открыт новый предмет: {name}!',
    order_in_progress: 'В процессе',
    order_completed_toast: 'Заказ выполнен! +{coins} монет ✦',
    reward_seeds_toast: '+{count} бесплатных семян получено! 🌱',
    not_enough_coins: 'Недостаточно монет для семечка!',
    cell_freed: 'Клетка освобождена! ✨',
  ...
  en: {
    ...
    main_menu: 'Main Menu',
    level_abbr: 'Lvl.',
    plot_level: 'Level: {level}/{max}',
    new_item_unlocked: 'New Item Unlocked: {name}!',
    order_in_progress: 'In Progress',
    order_completed_toast: 'Order Completed! +{coins} Coins ✦',
    reward_seeds_toast: '+{count} free seeds received! 🌱',
    not_enough_coins: 'Not enough coins for a seed!',
    cell_freed: 'Cell freed! ✨',
